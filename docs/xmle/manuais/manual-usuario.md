...
<img src="/assets/manual_usuario/xmle_manual_menu.png" alt="Menu principal"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_tela_principal.png" alt="Tela principal"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_cad_fornecedor.png" alt="Botão do Cadastro de Fornecedor"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_alreadycad.png" alt="Fornecedor já existe na SA2"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_incluirforn.png" alt="Incluindo fornecedor"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_print_config.png" alt="Configurações de Impressão"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_gerarentrada.png" alt="Tela com Gerar Entrada"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_conexaosefaz.png" alt="Conexão com o SEFAZ"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_tiponota.png" alt="Tipos de Notas"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_cartacorrecao.png" alt="Carta de Correção"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_geracaoentrada.png" alt="Gerar Entrada"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_submenu.png" alt="Sub menu Itens"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_telaitensnfe.png" alt="Tela Itens NF-e"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_relprodxfor.png" alt="Produto x Fornecedor"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_botaorelitens.png" alt="Produto x Fornecedor"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_produtosdisponiveis.png" alt="Produtos Disponíveis"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_ncnxml.png" alt="Botão NCN"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_buscapc.png" alt="Buscar somente com PC"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_telapc.png" alt="Tela de PC"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_prenotapend.png" alt="Pré-Nota"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_prenotalib.png" alt="Pré-Nota com todos os itens liberados"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_confirmaprenota.png" alt="Confirmar criação da Pré-Nota"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_telageraentrada.png" alt="Geração de entrada"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_abadupli.png" alt="Aba da duplicata"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_xmlxtes.png" alt="Confronto XML x TES"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_transsefaz.png" alt="Transmissão SEFAZ"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_telamanifestacao.png" alt="Tela de Manifestação"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_centralxmlenotaclas.png" alt="Central XML-e com nota classificada"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_menuoa.png" alt="Menu de Outras Ações"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_filtros.png" alt="Filtros"><br>
<span>Figura 29: Filtros possíveis</span></div>
<br>

<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_telapespar.png" alt="Tela de pesquisa mostrando os parâmetros"><br>
...
* **Documento de Entrada:** essa funcionalidade disponibiliza de uma maneira rápida as opções de Entrada de NF a fim de agilizar o dia a dia do usuário. A Figura 31, mostra as opções disponíveis.
    ...
    <div style="text-align: center">
    <img src="/assets/manual_usuario/xmle_opcoesde.png" alt="Opções de Documento de Entrada"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_avisonota.png" alt="Aviso sobre restrição"><br>
<span>Figura 32: Aviso sobre restrição para classificar nota</span></div>
<br>

<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_registrolegenamarela.png" alt="Registro com legenda amarela representando que existe uma Pré-Nota lançada"><br>
...
* **NF-e:** Engloba várias funções da NF-e no mesmo submenu a fim de agilizar o dia a dia do usuário. A Figura 34, mostra as opções disponíveis.
    ...
    <div style="text-align: center">
    <img src="/assets/manual_usuario/xmle_opcoesnfe.png" alt="Opções de NF-e"><br>
    ...
    * **Buscar Chave Avulsa:** ao invés de sincronizar todos os documentos, o sistema permite buscar uma chave específica. A Figura 35 mostra a tela de busca.
    ...
    <div style="text-align: center">
    <img src="/assets/manual_usuario/xmle_telabuscaca.png" alt="Tela de busca de chave avulsa"><br>
    ...
    * **Manifestar:** a tela de manifestação contém as seguintes partes: *Manifesto*, *Emitente* e *Nota Fiscal*, como mostra a Figura 36.
    ...
    <div style="text-align: center">
    <img src="/assets/manual_usuario/xmle_telamanifesdest.png" alt="Tela de Manifestação"><br>
    ...
    * **Monitorar:** essa opção serve para acompanhar a nota após a manifestação. A Figura 37 mostra um exemplo de informações necessárias para realizar o monitoramento.
    ...
    <div style="text-align: center">
    <img src="/assets/manual_usuario/xmle_telamonitoramento.png" alt="Tela de monitoramento"><br>
    ...
    * **Manifestar em Lote:** Através dessa opção é possível realizar a manifestação de um LOTE de XML de uma única vez. A Figura 38 mostra a tela de parâmetros necessária para filtrar quais notas serão manifestadas.,
    ...
    <div style="text-align: center">
    <img src="/assets/manual_usuario/xmle_parametrosparalote.png" alt="Parâmetros para manifestar em lote"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_manifesemlote.png" alt="Manifestação em lote"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_importarpdf.png" alt="Importar PDF de NFS-e"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_pastacompdf.png" alt="Pasta com PDF de NFS-e"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_importacaodenfs.png" alt="Importação de NFS-e por PDF"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_muninaohomolog.png" alt="Município não Homologado"><br>
...
* **CT-e:** Neste menu estão agrupadas as funções destinadas ao CT-e, conforme mostra a Figura 44 abaixo:
    ...
    <div style="text-align: center">
    <img src="/assets/manual_usuario/xmle_menudecte.png" alt="Menu de CT-e"><br>
    ...
    * **Buscar SEFAZ:** esta opção tem por objetivo buscar no SEFAZ nos últimos 90 dias, documentos que ainda não foram baixados automaticamente. 
    ...
    <div style="text-align: center">
    <img src="/assets/manual_usuario/xmle_buscasefaz.png" alt="Busca SEFAZ de CT-e"><br>
    ...
    * **Consulta Status:** esta opção tem por objetivo buscar o status do CTE selecionado junto ao SEFAZ, conforme figura 46.
    ...
    <div style="text-align: center">
    <img src="/assets/manual_usuario/xmle_consultastatus.png" alt="Consulta Status do CT-e no SEFAZ"><br>
    ...
    **Obs.** É necessário preencher uma observação com no mínimo 15 e no máximo 255 caracteres.
    ...
    <div style="text-align: center">
    <img src="/assets/manual_usuario/xmle_manifestacaodedesacordo.png" alt="Manifestação de Desacordo do CT-e no SEFAZ"><br>
...
* **Manutenção TI:** Menu destinado aos administradores do ERP Protheus de sua empresa, acesso apenas com permissão de Admin.
    ...
    <div style="text-align: center">
    <img src="/assets/manual_usuario/xmle_opcoesdemanutencao.png" alt="Opções de Manutenção TI"><br>
    ...
    * **Buscar Avançada SEFAZ (Somente Admin):** esta opção tem por objetivo sincronizar com a SEFAZ os documentos que ainda não sofreram manifestações do destinatário. A Figura 49 mostra a tela do sistema para essa opção.
    ...
    <div style="text-align: center">
    <img src="/assets/manual_usuario/xmle_telaparasincronizar.png" alt="Tela para sincronizar documentos"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_relatorios.png" alt="Relatórios"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_buscarxml.png" alt="Buscar XML por e-mail"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_telaexportacaoxml.png" alt="Tela de Exportação XML"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_menuimportxml.png" alt="Menu Importação de XML manual"><br>
<span>Figura 53: Menu Importação de XML manual</span></div>
<br>

<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_importxmlmanual.png" alt="Importação de XML manual"><br>
...
<img src="/assets/manual_usuario/xmle_entradaemlote.png" alt="Entrada em lote"></div>

<div>
<img src="/assets/manual_usuario/xmle_parametrosprenota.png" alt="Parâmetros para a entrada de Pré-notas em lote" style="width: 337px; height: 297px;"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_paramparaentrada.png" alt="Parâmetros para a entrada de Pré-notas em lote"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_significadolegend.png" alt="Significado das legendas"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_telaimpexport.png" alt="Tela de Impressão/Exportação"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_telafiltro.png" alt="Tela de filtro Gestão à vista"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_telagestao.png" alt="Tela de Gestão à vista"><br>
<span>Figura 60: Tela de Gestão à vista</span></div>
<br>

Caso necessite realizar outro filtro, basta clicar no botão ***Config*** <img src="/assets/manual_usuario/config-button.png" alt="Botão de Configuração"> ou pressionar a tecla F12 que a tela de filtro aparecerá novamente.
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_menucheckdoc.png" alt="Menu CheckDoc"><br>
<span>Figura 61: Menu CheckDoc</span></div>
<br>

<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_checkdocmanual.png" alt="CheckDoc Manual"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_confirmcheckdoc.png" alt="Confirmação CheckDoc"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_diretoriosaida.png" alt="Diretório onde será saldo o arquivo de análise do CheckDoc"><br>
...
<div style="text-align: center">
<img src="/assets/manual_usuario/xmle_relcheckdoc.png" alt="Relatório CheckDoc"><br>
